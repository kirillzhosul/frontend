...
export function PrivacyPolicyPage() {
  return (
    <div className="text-left flex flex-col items-center max-w-[50%] mx-auto mt-10 gap-4">
      <h1 className="font-bold">Privacy Policy of Kirill Zhosul</h1>

      <p>
        <i className="underline">Kirill Zhosul</i> operates the{" "}
        <Link href="https://kirillzhosul.ru">
          <i className="underline">https://kirillzhosul.ru</i>
        </Link>{" "}
      ...
      <p>
        ...
        <i className="underline">Kirill Zhosul</i> website.
      </p>
